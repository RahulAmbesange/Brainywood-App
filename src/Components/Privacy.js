...
import logo from "../Components/Images/std1.jpg"
        ...
        <div>
            <div className='maindiv'>
                ...
                <div className='submaindiv'>
                    ...
                    <div className='subheading' id='subhead'>
                        <h2>Use of your Personal Information</h2>
                        <p>We use the collected Information to analyse trends, to conduct research, to administer the Application,Services and products, to learn about each user's learning patterns and movements around the Application/Services and products and to gather demographic information and usage behaviour about our user base as a whole. Aggregated and individual, anonymized and non-anonymized data may periodically be transmitted to external service providers to help us improve the Application, products and our Services. We will share your information with third parties only in the ways that are described below in this Policy. We may use the individual data and behavior patterns combined with personal information to provide you with personalized content, and better your learning objectives. Third parties provide certain services which we may use to analyze the data and information to personalize, drive insights and help us better your experience or reach out to you with more value added applications, products, information and services. However, these third party companies do not have any independent right to share this information. We do not sell, trade or rent your Information to any third party unless, we have been expressly authorized by you either in writing or electronically to do so. We may at times provide aggregate statistics about our customers, traffic patterns, and related site information to reputable third parties, however this information when disclosed will be in an aggregate form and does not contain any of your Personally Identifiable Information. Brainywood will occasionally send email notices or contact you to communicate about our Services, products and benefits, as they are considered an essential part of the Services,products you have chosen. We may disclose Information:</p>

                        <div className='subheading1'>
                            <div className='one'><span><BsDot /></span></div>
                            <div className='text1'><p>as required by law, such as to comply with a subpoena, or similar legal process;</p></div>
                        </div>

                        <div className='subheading1'>
                            <div className='one'><span><BsDot /></span></div>
                            <div className='text1'><p>to enforce applicable ToU, including investigation of potential violations thereof;</p></div>
                        </div>

                        <div className='subheading1'>
                            <div className='one'><span><BsDot /></span></div>
                            <div className='text1'><p>when we believe in good faith that disclosure is necessary to protect our rights, protect your safety or the safety of others, investigate fraud, address security or technical issues or respond to a government request;</p></div>
                        </div>

                        <div className='subheading1'>
                            <div className='one'><span><BsDot /></span></div>
                            <div className='text1'><p>with our trusted services providers who work on our behalf, do not have an independent use of the information we disclose to them, and have agreed to adhere to the rules set forth in this Policy;</p></div>
                        </div>

                        <div className='subheading1'>
                            <div className='one'><span><BsDot /></span></div>
                            <div className='text1'><p>to protect against imminent harm to the rights, property or safety of the Application,Website or its users or the public as required or permitted by law;</p></div>
                        </div>

                        <div className='subheading1'>
                            <div className='one'><span><BsDot /></span></div>
                            <div className='text1'><p>with third party service providers in order to personalize the Application Website Services products for a better user experience and to perform behavioural analysis;</p></div>
                        </div>

                        <div className='subheading1'>
                            <div className='one'><span><BsDot /></span></div>
                            <div className='text1'><p>Any portion of the Information containing personal data relating to minors provided by you shall be deemed to be given with the consent of the minor's legal guardian. Such consent is deemed to be provided by your registration with us.</p></div>
                        </div>
                    </div>
                    ...
                    <div className='subheading'>
                        <h2>Alerts</h2>
                        <p>We may alert you by email or phone (through sms ro call) to inform you about new service offerings or other information which we feel might be useful for you.</p>
                    </div>
                    ...
                    <div className='subheading' id='gap'>
                        <h2>Terms & Conditions</h2>
                        <p>These Terms & Conditions (“<b>Terms</b>”) of (a) use of our website www.brainywoodindia.com (“<b>Website</b>”), our applications (“<b>Application</b>”) or any products or services in connection with the Application,  Website,products (“<b>Services</b>”)  or (b) any modes of registrations or usage of products, including through SD cards, tablets or other storage transmitting device  are between Vedic Brain (“<b>Company/We/Us/Our</b>”) and its users (“<b>User/You/Your</b>”).</p>
                        ...
                        <p>If You do not agree with the Terms or the Privacy Policy, please do not use the Application or Website or avail the Services or products. Any access to our Services Application products through registrations subscription is non transferable.</p><br />
                    </div>
                    {/* id='marleft' */}
                    <div className='subheading1'>
                        <div className='one' id='numbers'><p>1.</p></div>
                        <div className='text'><p>Except as mentioned below, all information, content, material, trademarks, services marks, trade names, and trade secrets including but not limited to the software, text, images, graphics, video, script and audio, contained in the Application, Website, Services and products are proprietary property of the Company (“Proprietary Information”).  No Proprietary Information may be copied, downloaded, reproduced, modified, republished, uploaded, posted, transmitted or distributed in any way without obtaining prior written permission from the Company and nothing on this Application or Website or Services shall be or products deemed to confer a license of or any other right, interest or title to or in any of the intellectual property rights belonging to the Company, to the User. You may own the medium on which the information, content or materials resides, but the Company shall at all times retain full and complete title to the information, content or materials and all intellectual property rights inserted by the Company on such medium. Certain contents on the Website may belong to third parties. Such contents have been reproduced after taking prior consent from said party and all rights relating to such content will remain with such third party. Further, you recognize and acknoweldge that the ownership of all trademarks, copyright, logos, service marks and other intellectual property owned by any third party shall continue to vest with such party and You are not permitted to use the same without the consent of the respective third party.</p>
                        </div>
                    </div>
                    <div className='subheading1'>
                        <div className='one' id='numbers'><p>1.</p></div>
                        <div className='text'><p>Your use of our products Website Application and Services is solely for Your personal and non-commercial use. Any use of the Application Website Services or products or  their contents other than for personal purposes is prohibited. Your personal and non-commercial use of this Application, Website, products and  or our Services shall be subjected to the following restrictions:</p>
                        </div>
                    </div>

                    <div className='subheading1'>
                        <div className='one' id='number'><p>1.</p></div>
                        <div className='textt1'><p>You may not decompile, reverse engineer, or disassemble the contents of the Application and or our Website and or Services products or modify, copy, distribute, transmit, display, perform, reproduce, publish, license, create derivative works from, transfer, or sell any information or software obtained from the Application and or our Website and or Services products, or remove any copyright, trademark registration, or other proprietary notices from the contents of the Application and or and or our Website and/or Services products.</p>
                        </div>
                    </div>
                    <div className='subheading1'>
                        <div className='one' id='number'><p>2.</p></div>
                        <div className='textt1'><p>You will not (a) use this Application and or our Website and or any of our products or Services for commercial purposes of any kind, or (b) advertise or sell the Application or any products, Services or domain names or otherwise (whether or not for profit), or solicit others (including, without limitation, solicitations for contributions or donations) or use any public forum for commercial purposes of any kind, or (c) use the Application and or Website/our products and Services in any way that is unlawful, or harms the Company or any other person or entity as determined by the Company.</p>
                        </div>
                    </div>
                    <div className='subheading1'>
                        {/* id='ml' */}
                        <div className='one' id='number'><p>3.</p></div>
                        <div className='textt1'><p>No User shall be permitted to perform any of the following prohibited activities while availing our Services:</p>
                        </div>
                    </div>
                    <div className='subheading1'>
                        <div className='one' id='number1'><p>1. </p></div>
                        <div className='texttb1'><p>Making available any content that is misleading, unlawful, harmful, threatening, abusive, tortious, defamatory, libelous, vulgar, obscene, child-pornographic, lewd, lascivious, profane, invasive of another's privacy, hateful, or racially, ethnically or otherwise objectionable;</p>
                        </div>
                    </div>

                    <div className='subheading1'>
                        <div className='one' id='number1'><p>2. </p></div>
                        <div className='texttb1'><p>Stalking, intimidating and/or harassing another and/or inciting other to commit violence;</p>
                        </div>
                    </div>


                    <div className='subheading1'>
                        <div className='one' id='number1'><p>3 </p></div>
                        <div className='texttb1'><p>Transmitting material that encourages anyone to commit a criminal offence, that results in civil liability or otherwise breaches any relevant laws, regulations or code of practice;</p>
                        </div>
                    </div>

                    <div className='subheading1'>
                        <div className='one' id='number1'><p>4. </p></div>
                        <div className='texttb1'><p> Interfering with any other person's use or enjoyment of the Application Website Services;</p>
                        </div>
                    </div>

                    <div className='subheading1'>
                        <div className='one' id='number1'><p>5. </p></div>
                        <div className='texttb1'><p>Making, transmitting or storing electronic copies of materials protected by copyright without the permission of the owner, committing any act that amounts to the infringement of intellectual property or making available any material that infringes any intellectual property rights or other proprietary rights of anyone else;</p>
                        </div>
                    </div>

                    <div className='subheading1'>
                        <div className='one' id='number1'><p>6. </p></div>
                        <div className='texttb1'><p>Make available any content or material that You do not have a right to make available under any law or contractual or fiduciary relationship, unless You own or control the rights thereto or have received all necessary consents for such use of the content;</p>
                        </div>
                    </div>

                    <div className='subheading1'>
                        <div className='one' id='number1'><p>7. </p></div>
                        <div className='texttb1'><p>Impersonate any person or entity, or falsely state or otherwise misrepresent Your affiliation with a person or entity;</p>
                        </div>
                    </div>

                    <div className='subheading1'>
                        <div className='one' id='number1'><p>8. </p></div>
                        <div className='texttb1'><p>Post, transmit or make available any material that contains viruses, trojan horses, worms, spyware, time bombs, cancelbots, or other computer programming routines, code, files or such other programs that may harm the Application/services, interests or rights of other users or limit the functionality of any computer software, hardware or telecommunications, or that may harvest or collect any data or personal information about other Users without their consent;</p>
                        </div>
                    </div>

                    <div className='subheading1'>
                        <div className='one' id='number1'><p>9. </p></div>
                        <div className='texttb1'><p>Access or use the Application Website Services products in any manner that could damage, disable, overburden or impair any of the Application'sWebsite's servers or the networks connected to any of the servers on which the Application/Website is hosted;</p>
                        </div>
                    </div>

                    <div className='subheading1'>
                        <div className='one' id='number1'><p>10. </p></div>
                        <div className='texttb1'><p>Intentionally or unintentionally interfere with or disrupt the services or violate any applicable laws related to the access to or use of the Application Website Services products, violate any requirements, procedures, policies or regulations of networks connected to the Application Website Services products, or engage in any activity prohibited by these Terms;</p>
                        </div>
                    </div>

                    <div className='subheading1'>
                        <div className='one' id='number1'><p>11. </p></div>
                        <div className='texttb1'><p>Disrupt or interfere with the security of, or otherwise cause harm to, the Application Website Services products, materials, systems resources, or gain unauthorized access to user accounts, passwords, servers or networks connected to or accessible through the Application Website Services products or any affiliated or linked sites;</p>
                        </div>
                    </div>

                    <div className='subheading1'>
                        <div className='one' id='number1'><p>12. </p></div>
                        <div className='texttb1'><p>Interfere with, or inhibit any user from using and enjoying access to the Application Website Services products, or other affiliated sites, or engage in disruptive attacks such as denial of service attack on the Application Website Services products;</p>
                        </div>
                    </div>

                    <div className='subheading1'>
                        <div className='one' id='number1'><p>13. </p></div>
                        <div className='texttb1'><p>Use deep-links, page-scrape, robot, spider or other automatic device, program, algorithm or methodology, or any similar or equivalent manual process, to increase traffic to the Application Website Services products, to access, acquire, copy or monitor any portion of the Application Website Services products, or in any way reproduce or circumvent the navigational structure or presentation of the Application, or any content, to obtain or attempt to obtain any content, documents or information through any means not specifically made available through the Application/ Website/Services/products;</p>
                        </div>
                    </div>

                    <div className='subheading1'>
                        <div className='one' id='number1'><p>14. </p></div>
                        <div className='texttb1'><p>Alter or modify any part of the Services;</p>
                        </div>
                    </div>
                    <div className='subheading1' >
                        <div className='one' id='number1'><p>15. </p></div>
                        <div className='texttb1'><p>Use the Services for purposes that are not permitted by: (i) these Terms; and (ii) any applicable law, regulation or generally accepted practices or guidelines in the relevant jurisdiction; or</p>
                        </div>
                    </div>
                    <div className='subheading1' >
                        <div className='one' id='number1'><p>16. </p></div>
                        <div className='texttb1'><p>Violate any of the terms specified under the Terms for the use of the Application Website Services products.</p>
                        </div>
                    </div>
